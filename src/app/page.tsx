        ...
        <div className="container py-6 flex flex-col items-center justify-center gap-4">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
                ...
                <div className="flex items-center gap-2 text-sm text-foreground/70">
                  ...
                  <a href="https://www.behance.net/europeudesigner" target="_blank" rel="noopener noreferrer" aria-label="Behance Profile" className="text-foreground/70 hover:text-primary transition-colors font-medium underline">
                      Behance.com
                  </a>
                </div>
            </div>
